...
REPOS="terraform-iam terraform-vpc terraform-eks terraform-data-integration-student terraform-rds-mysql terraform-ghost ubuntu-on-kubernetes terraform-prometheus terraform-grafana terraform-kubernetes-dashboard"
